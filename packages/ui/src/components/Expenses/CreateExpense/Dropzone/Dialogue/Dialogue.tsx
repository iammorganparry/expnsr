...
import { AnimatedDots, ImageContainer, StyledDialog, StyledDialogContent, StyledLinearProgress, StyledTextContainer } from "./Dialogue.styles"
        ...
        <StyledDialog maxWidth='lg' open={open}>
            <StyledDialogContent>
              ...
              />
                ...
                <StyledTextContainer>
                    <Typography variant='body2' color='textPrimary'>Extracting items from receipt</Typography>
                    <AnimatedDots/>
                </StyledTextContainer>
            </StyledDialogContent>
        </StyledDialog>
